...
void DeferredRenderer::Initialize()
{
	...
	const UINT w{ m_GameContext.windowWidth };
	const UINT h{ m_GameContext.windowHeight };
...
void DeferredRenderer::End(const SceneContext& sceneContext) const
{
	...
	rTargets[0] = m_pDefaultRenderTargetView; //Set this to do step 1 & 2 in the same call
	...
	//pDeviceContext->OMSetRenderTargets(1, &m_pDefaultRenderTargetView, nullptr); //See Comment rTargets[0]
